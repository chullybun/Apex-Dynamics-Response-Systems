...
public partial class HostTests : WithApiTester<ApexDynamics.TitanWatch.ResponseSys.Api.Program>
{
    [OneTimeSetUp]
    ...
    public void Swagger_Json()
    {
        Test.Http()
            ...
            .GetContent().Should().BeJson()
                ...
                .HavePath("$.info.title").GetValue<string>().Should().Be("ApexDynamics.TitanWatch.ResponseSys.Api");
    }
