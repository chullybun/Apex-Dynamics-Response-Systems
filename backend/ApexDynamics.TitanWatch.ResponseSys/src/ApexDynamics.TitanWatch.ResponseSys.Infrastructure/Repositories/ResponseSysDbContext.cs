...
/// <summary>Provides the <b>ResponseSys</b> <see cref="DbContext"/> with <see cref="IEfDbContext"/> support.</summary>
public partial class ResponseSysDbContext(DbContextOptions<ResponseSysDbContext> options, PostgresDatabase database) : DbContext(options), IEfDbContext
{
    /// <inheritdoc/>
