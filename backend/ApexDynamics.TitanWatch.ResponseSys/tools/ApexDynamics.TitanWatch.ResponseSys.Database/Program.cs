...
namespace ApexDynamics.TitanWatch.ResponseSys.Database;
...
public class Program
{
    ...
    public static Task<int> Main(string[] args) => PostgresMigrationConsole
        .Create<Program>("Server=127.0.0.1;Database=responsesys;Username=postgres;Password=yourStrong#!Password")
    ...
    public static MigrationArgs ConfigureMigrationArgs(MigrationArgs args)
    {
        ...
        args.DataResetFilterPredicate = ts => ts.Schema == "responsesys";   // Only reset data for the specified schema.
        return args;
    }
}
