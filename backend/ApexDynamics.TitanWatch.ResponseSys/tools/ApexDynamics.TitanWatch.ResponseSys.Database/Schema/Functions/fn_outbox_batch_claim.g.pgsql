CREATE OR REPLACE FUNCTION "responsesys"."fn_outbox_batch_claim"(
...
BEGIN
  ...
  FROM "responsesys"."fn_outbox_lease_acquire"(
    p_partition_id,
    p_lease_id,
    p_lease_seconds,
  ...
  IF _head_id IS NULL THEN
    -- Release the lease.
    PERFORM "responsesys"."fn_outbox_lease_release"(p_lease_id);
